...
class Ui_imageAI(object):
    def setupUi(self, imageAI):
        ...
        # 窗体美化
        imageAI.setStyleSheet("background-image:url(static/img/bg1.jpg)")
    ...
    def openfile(self):
        ...
        if not self.path[0].strip():
            ...
            self.label_33.setPixmap(QPixmap('D:\python\Django-2.2.24\milk\static\img\grey2.png'))
...
def indentify(request):
    if request.method=='GET':
        return render(request, 'indentify.html')
    else:
